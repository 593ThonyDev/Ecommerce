...
import { PATH_BLOG_ARTICULO_ID } from "../../../routes/public/Paths"

const Blog = () => {

    return (
        <div className="col-span-1 h-fit w-full xl:col-span-1 2xl:col-span-5 mb-2 bg-primary-50 ">
            ...
            <div className="flex justify-center lg:pb-8">
                <div className="flex justify-center">
                    <div className="grid lg:grid-cols-2 lg:gap-6">
                        <Link to={PATH_BLOG_ARTICULO_ID} className="flex flex-col items-center bg-white hover:bg-primary-100  lg:rounded-lg  md:flex-row md:max-w-xl border border-primary-100 hover:border-primary-100 hover:border">
