        ...
        <>
            {isLoading ? (
                ...
                <div className=' relative -mb-16 lg:mx-48 mt-5'>
                    <div className="container flex flex-row justify-around mx-auto bg-primary-200 md:rounded-3xl lg:rounded-3xl pb- lg:py-1 py-5">
                        <div className="max-w-[1640px] m-auto">
                            <h1 className="text-white font-bold text-4xl text-center py-1 pt-3 pb-2 px-2">
                                Categorias de nuestros productos
                            </h1>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 lg:px-2 px-4 lg:pb-2">
                                {data.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <h2 className="text-sm my-auto pl-2 line-clamp-2">{item.name}</h2>
                                    </Link>
                                ))}
                            </div>
                        </div>
