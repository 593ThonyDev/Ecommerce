...
import { PATH_CLIENTES_ADMIN } from "../../../routes/private/PrivatePaths"
        ...
        <div className="flex flex-wrap justify-center py-10">
            <div className="relative w-full px-4 mb-10 md:w-1/2 lg:mb-0 z-10">
                ...
                <div className="grid lg:pt-4">
                    ...
                    <div className="py-3">
                        <TextArea label="Direccion de residencia:" placeholder={""} rows={0} />
                    </div>
                </div>
                ...
                <div className="grid justify-center ">
                    <div className="flex justify-center pt-9 gap-x-5">
                        ...
                        <div className="text-white bg-primary-500 hover:bg-primary-600 py-2 px-3 rounded-xl cursor-pointer">Crear cliente</div>
                    </div>
                </div>
