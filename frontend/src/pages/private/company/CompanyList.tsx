...
import { PATH_ADMIN_COMPANY_EDIT } from '../../../routes/private/PrivatePaths'
            ...
            <div className="relative w-full px-4 mb-10 md:w-1/2 lg:mb-0 z-10">
                <div className="relative">
                    <div className="flex items-center justify-center">
                        ...
                        <div className="absolute lg:top-80 bottom-4 z-40 lg:right-28 sm:right-60 lg:py-4 rounded-full right-10 p-4  cursor-pointer bg-warning-400 hover:bg-warning-500/40 backdrop-blur-lg text-white">
