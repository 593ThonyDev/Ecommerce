                        ...
                        <div className="flex flex-wrap">
                            ...
                            <div className="w-full px-4 mb-10 md:w-1/2 lg:mb-0 ">
                                <div className="flex justify-between">
                                    ...
                                    <Dropdown label={'•••'}>
                                        <DropdownItem text={'Editar cliente'} path={PATH_EMPLEADO_ADMIN_EDIT_ID + formData.idCustomer + "/" + formData.fullName?.replace(/\s+/g, '-')} />
                                        <DropdownItem text={'Dar de baja'}/>
                                        <DropdownItem text={'Restaurar contraseña'} />
                                    </Dropdown>
                                </div>
                                <ul className="mb-10">
