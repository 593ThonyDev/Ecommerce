...
import { PATH_BLOG, PATH_CHECK_ORDER, PATH_HOME, PATH_LOGIN, PATH_MY_ORDERS, PATH_NOSOTROS, PATH_PAYMENT, PATH_PRODUCTO, PATH_PRODUCTOS, PATH_PRODUCTOS_CATEGORY, PATH_REGISTER } from "./Paths";
